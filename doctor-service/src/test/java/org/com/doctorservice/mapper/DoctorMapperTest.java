...
public class DoctorMapperTest {
    ...
    void setUp() {
        ...
        this.event = new UserRegisteredEvent(
    ...
    void toModelShouldSuccessfullyMap() {
        Doctor mappedDoctor = DoctorMapper.toModel(event);

        assertEquals(mappedDoctor.getFirstName(), event.firstName());
        assertEquals(mappedDoctor.getLastName(), event.lastName());
        assertEquals(mappedDoctor.getEmail(), event.email());
    }
}